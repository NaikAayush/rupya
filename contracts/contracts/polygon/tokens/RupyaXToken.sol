...
contract RupyaXToken {
    ...
    function createRupyaXToken(ERC20WithTokenInfo mkrToken) public returns (ISuperToken mkrSuperToken) {
        
        string memory name = string(abi.encodePacked('Rupya ', mkrToken.name()));
